...
podTemplate(label: 'mypod', containers: [
  ...
  node('mypod') {
      ...
      stage('Update Kubernetes') {
          container('kubectl') {
              sh "kubectl set image deployments/csye7374-rc csye7374=557502683643.dkr.ecr.us-east-1.amazonaws.com/csye7374:${image_id}"
...
podTemplate(label: 'mypod', containers: [
  ...
  node('mypod') {
      ...
      stage('Update Kubernetes') {
          container('kubectl') {
              sh "kubectl rolling-update csye7374-rc --image-pull-policy Always --image 757638245294.dkr.ecr.us-east-1.amazonaws.com/csye7374:latest"
          }
      }
  }
  }
